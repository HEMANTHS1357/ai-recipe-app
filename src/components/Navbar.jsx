...
import { ChefHat, Home, UtensilsCrossed, Calendar, ShoppingCart, Settings } from 'lucide-react';
...
const NavLink = ({ to, icon, label }) => (
    <Link to={to} className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-700 hover:text-emerald-600 hover:bg-emerald-50 rounded-lg transition-colors">
        {icon}
        <span>{label}</span>
    </Link>
);
