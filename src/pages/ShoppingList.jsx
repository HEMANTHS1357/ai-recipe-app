...
const ShoppingListItem = ({ item, onToggle, onDelete }) => (
    <div className="flex items-center gap-4 px-6 py-4 hover:bg-gray-50 transition-colors group">
        <button onClick={() => onToggle(item.id)} className="shrink-0">
            <div className={`w-6 h-6 rounded border-2 flex items-center justify-center transition-all ${item.is_checked ? 'bg-emerald-500 border-emerald-500' : 'border-gray-300 hover:border-emerald-500'}`}>
            ...
            <div className="bg-white rounded-xl max-w-md w-full p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input type="text" value={formData.ingredient_name}
